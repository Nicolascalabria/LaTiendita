...
namespace LaTiendita.Migrations
{
    ...
    [Migration("20220622012653_AgregoUsuarioAdministradorPorDefecto")]
    partial class AgregoUsuarioAdministradorPorDefecto
    {
            ...
            modelBuilder.Entity("LaTiendita.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaDeCreacion = new DateTime(2022, 6, 21, 22, 26, 53, 832, DateTimeKind.Local).AddTicks(2283),
                            Nombre = "Admin",
                            Rol = 0
                        });
                });
